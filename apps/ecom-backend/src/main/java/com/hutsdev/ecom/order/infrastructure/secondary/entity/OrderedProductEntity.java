package com.hutsdev.ecom.order.infrastructure.secondary.entity;

import com.hutsdev.ecom.order.domain.order.aggregate.OrderedProduct;
import com.hutsdev.ecom.order.domain.order.aggregate.OrderedProductBuilder;
import com.hutsdev.ecom.order.domain.order.vo.OrderPrice;
import com.hutsdev.ecom.order.domain.order.vo.OrderQuantity;
import com.hutsdev.ecom.order.domain.order.vo.ProductPublicId;
import com.hutsdev.ecom.product.domain.vo.ProductName;
...
public class OrderedProductEntity {
  ...
  public int hashCode() {
    ...
    result = 31 * result + Long.hashCode(quantity);
