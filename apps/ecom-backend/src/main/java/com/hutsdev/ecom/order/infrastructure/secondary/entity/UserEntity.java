...
import com.hutsdev.ecom.order.domain.user.aggregate.UserBuilder;
...
public class UserEntity extends AbstractAuditingEntity<Long> {
  ...
  public UserEntity(Long id, String lastName, String firstName, String email, UUID publicId, String addressStreet, String addressZipCode, String addressCity, Instant lastSeen, Set<AuthorityEntity> authorities) {
    this.id = id;
